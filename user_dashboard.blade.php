    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col text-center">
                ...
                {{-- <h3>Ini adalah halaman User Dashboard</h3> --}}
            </div>
        </div>
        <div class="row mt-4">
            <div class="col-md-4 mb-4">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <p class="card-text">Klik untuk lihat materi pembelajaran.</p>
            ...
            <div class="col-md-4 mb-4">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <p class="card-text">Klik untuk mulai kuis.</p>
            ...
            <div class="col-md-4 mb-4">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title mt-2">Games</h5>
                        <p class="card-text">Klik untuk mulai games.</p>
                        <a href="#" class="btn btn-primary">Mulai Games</a>
                    </div>
                </div>
            </div>
        </div>
